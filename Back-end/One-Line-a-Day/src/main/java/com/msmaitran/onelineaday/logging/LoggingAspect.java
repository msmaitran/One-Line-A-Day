package com.msmaitran.onelineaday.logging;
...
public class LoggingAspect {
    ...
    @Around(value = "@within(com.msmaitran.onelineaday.logging.Loggable) || @annotation(com.msmaitran.onelineaday.logging.Loggable)")
