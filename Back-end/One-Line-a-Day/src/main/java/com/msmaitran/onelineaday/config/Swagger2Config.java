package com.msmaitran.onelineaday.config;

import com.fasterxml.classmate.TypeResolver;
import com.msmaitran.onelineaday.models.ErrorDetail;
import com.msmaitran.onelineaday.models.TokenModel;
...
public class Swagger2Config {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("com.msmaitran"))
    ...
    private ApiInfo apiEndPointsInfo() {
        return new ApiInfoBuilder().title("One Line a Day")
                .description("Backend Documentation")
                .contact(new Contact("Mai Tran",
                        "http://www.lambdaschool.com",
                        "itsmaitran@gmail.com"))
                .license("MIT")
                .licenseUrl("https://github.com/One-Line-A-Day-11-19/Back-end/blob/master/LICENSE")
                .version(("1.0.0"))
                .build();
    }
}
